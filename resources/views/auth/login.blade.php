<x-guest-layout>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-8">
                    <h1 class="text-4xl font-bold text-white mb-2 tracking-tight">TeknoShop</h1>
                ...
                <div class="bg-white backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden hover-scale">
                    <div class="grid md:grid-cols-2 gap-0">
                        <div class="relative p-6 hidden md:block">
                            ...
                            <img src="{{ asset('img/login.png') }}" alt="TeknoShop Logo" class="w-full h-full object-cover rounded-2xl floating">
                        </div>
                        <div class="p-8 sm:p-12">
                            ...
                            <form id="loginForm" method="POST" action="{{ route('login') }}" class="space-y-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-800 hover:text-blue-600" onclick="togglePasswordVisibility('password')">
                                ...
                                <button type="submit" class="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg">Sign In</button>
                                <p class="text-center text-blue-800">Don't have an account? <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-800 font-medium">Create one</a></p>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // Show SweetAlert if there are errors from the server
        @if($errors->any())
            Swal.fire({
                icon: 'error',
