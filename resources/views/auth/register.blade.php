            ...
            <form id="registerForm" method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-800 hover:text-blue-600" onclick="togglePasswordVisibility('password_confirmation')">
                            <i id="icon-password_confirmation" class="fa fa-eye-slash"></i>
                        </button>
                    </div>
                </div>
                <div class="flex flex-col items-center mt-8">
                    <button type="submit" class="w-full md:w-auto px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg">Register</button>
                    <p class="mt-4 text-black">Already have an account? <a href="{{ route('login') }}" class="text-orange-300 hover:text-orange-400 font-medium">Login here</a></p>
                </div>
            </form>
        </div>
    </div>
