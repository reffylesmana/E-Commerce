...
@section('title', 'Pesanan Dikirim - TechnoShop')
@section('description', 'Lihat pesanan yang sedang dalam pengiriman di TechnoShop')
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                  <div class="flex items-center">
                      ...
                      <span class="ml-1 text-gray-500 dark:text-gray-400 md:ml-2">Dikirim</span>
                  </div>
              </li>
          </ol>
      </nav>

      <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Pesanan Dikirim</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                      ...
                      <div class="p-6">
                          ...
                          <div class="space-y-3 text-sm">
                              ...
                              <div class="flex justify-between">
                                  ...
                                  <span class="text-gray-900 dark:text-white">{{ $order->shipping->tracking_number ?? 'Belum tersedia' }}</span>
                              </div>
                          </div>
                              ...
                              <div class="flex flex-col">
                                  <div class="flex items-center mb-3">
                                      <div class="relative w-full bg-gray-200 dark:bg-gray-700 h-2 rounded-full overflow-hidden">
                                          <div class="absolute top-0 left-0 h-full bg-purple-500 w-3/4"></div>
                                      </div>
                                      <span class="ml-3 text-xs text-gray-500 dark:text-gray-400">75%</span>
                                  </div>
          ...
          @else
              <div class="col-span-1 md:col-span-2 lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl shadow-md p-10 text-center">
                  ...
                  <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Tidak Ada Pesanan yang Sedang Dikirim</h3>
                  <p class="text-gray-500 dark:text-gray-400 mb-6">Saat ini tidak ada pesanan yang sedang dalam pengiriman.</p>
