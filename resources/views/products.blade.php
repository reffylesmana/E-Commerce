                                    ...
                                    @endif
                                        ...
                                        <div class="flex items-center mb-2">
                                            <div class="flex text-yellow-400">
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <svg xmlns="http://www.w3.org/2000/svg" 
                                                         class="w-5 h-5 {{ $i <= ($product->reviews_avg_rating ?? 0) ? 'text-yellow-400' : 'text-gray-400' }}" 
                                                         fill="currentColor" 
                                                         viewBox="0 0 24 24">
                                                        <path d="M12 .587l3.668 7.571L24 9.748l-6 5.848 1.416 8.264L12 18.897l-7.416 4.963L6 15.596 0 9.748l8.332-1.59z"/>
                                                    </svg>
                                                @endfor   
                                            </div>
