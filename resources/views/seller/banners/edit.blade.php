...
@section('title', 'Edit Banner - TechnoShop Seller')
@section('description', 'Edit banner untuk ditampilkan di halaman utama TechnoShop')
...
<div class="container px-6 mx-auto grid">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-md">
        <div class="w-full overflow-x-auto p-6">
            <form action="{{ route('seller.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                      ...
                      <div class="flex items-center justify-center w-full">
                          <label for="image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                              <div id="image-placeholder" class="flex flex-col items-center justify-center pt-5 pb-6 {{ $banner->image_path ? 'hidden' : '' }}">
                              ...
                              <div id="image-preview" class="{{ $banner->image_path ? '' : 'hidden' }}">
                                  <img id="preview-image" src="{{ $banner->image_path ? Storage::url($banner->image_path) : '#' }}" alt="Preview" class="h-64 object-contain">
                              </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-40">{{ old('description', $banner->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
