    ...
    <div class="container mx-auto max-w-7xl">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            ...
            <div id="customDateRange" class="hidden flex items-center space-x-2">
                <input type="date" id="startDate" class="border-gray-300 rounded-md text-sm focus:ring-indigo-500 focus:border-indigo-500">
                <span>sampai</span>
                <input type="date" id="endDate" class="border-gray-300 rounded-md text-sm focus:ring-indigo-500 focus:border-indigo-500">
                <button id="applyDateRange" class="px-3 py-1 bg-indigo-600 text-white text-sm rounded-md hover:bg-indigo-700 transition-colors">
                    Terapkan
                </button>
            </div>
        </div>
        ...
        <div class="stats-grid mb-8">
            ...
            <div class="stat-card green animate-fade-in">
                <div class="stat-icon green">
                    <i class="iconify text-2xl" data-icon="tabler:currency-rupiah"></i>
                </div>
            ...
            <div class="stat-card blue animate-fade-in-delay-1">
                ...
                <div class="stat-trend {{ ($orderGrowth ?? 0) >= 0 ? 'up' : 'down' }}">
                    <i class="iconify mr-1" data-icon="{{ ($orderGrowth ?? 0) >= 0 ? 'tabler:arrow-up-right' : 'tabler:arrow-down-right' }}"></i>
            ...
            <div class="stat-card purple animate-fade-in-delay-2">
                ...
                <div class="stat-trend {{ ($aovGrowth ?? 0) >= 0 ? 'up' : 'down' }}">
                    <i class="iconify mr-1" data-icon="{{ ($aovGrowth ?? 0) >= 0 ? 'tabler:arrow-up-right' : 'tabler:arrow-down-right' }}"></i>
            ...
            <div class="stat-card yellow animate-fade-in-delay-3">
                ...
                <div class="stat-trend {{ ($conversionGrowth ?? 0) >= 0 ? 'up' : 'down' }}">
                    <i class="iconify mr-1" data-icon="{{ ($conversionGrowth ?? 0) >= 0 ? 'tabler:arrow-up-right' : 'tabler:arrow-down-right' }}"></i>
        ...
        <div class="stats-grid mb-8">
            ...
            <div class="stat-card yellow animate-fade-in">
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <a href="{{ route('seller.transactions.orders.orders', ['status' => 'pending']) }}" class="text-xs text-indigo-600 hover:text-indigo-800">Lihat Semua</a>
                </div>
            </div>
            ...
            <div class="stat-card blue animate-fade-in-delay-1">
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <a href="{{ route('seller.transactions.orders.orders', ['status' => 'processing']) }}" class="text-xs text-indigo-600 hover:text-indigo-800">Lihat Semua</a>
                </div>
            </div>
            ...
            <div class="stat-card red animate-fade-in-delay-2">
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <a href="{{ route('seller.products.index', ['stock' => 'low']) }}" class="text-xs text-indigo-600 hover:text-indigo-800">Lihat Semua</a>
                </div>
            </div>
            ...
            <div class="stat-card pink animate-fade-in-delay-3">
                ...
                <div class="flex justify-between items-center mt-2">
                    {{-- <div class="text-xs text-gray-500">Rating rata-rata: {{ number_format($averageRating ?? 0, 1) }}/5</div> --}}
        ...
        <div class="chart-card animate-fade-in mb-8">
            <div class="chart-header">
                ...
                <div class="flex space-x-2">
                    <button class="chart-period-btn px-3 py-1 text-xs font-medium rounded-md bg-indigo-100 text-indigo-700" data-period="daily">Harian</button>
                    <button class="chart-period-btn px-3 py-1 text-xs font-medium rounded-md text-gray-500 hover:bg-gray-100" data-period="weekly">Mingguan</button>
                    <button class="chart-period-btn px-3 py-1 text-xs font-medium rounded-md text-gray-500 hover:bg-gray-100" data-period="monthly">Bulanan</button>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="chart-card animate-fade-in">
                <div class="chart-header">
                    ...
                    <select id="productPerformanceMetric" class="border-gray-300 rounded-md text-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="table-card animate-fade-in mb-8">
            <div class="table-header">
                ...
                <a href="{{ route('seller.transactions.orders.orders') }}" class="text-sm text-indigo-600 hover:text-indigo-800">Lihat Semua Pesanan</a>
            </div>
                ...
                <table class="dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('seller.transactions.orders.show', $order->id) }}" class="text-indigo-600 hover:text-indigo-800">Detail</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="text-center py-8 text-gray-500">
                                <div class="flex flex-col items-center">
                                    <i class="iconify text-4xl mb-3 text-gray-400" data-icon="tabler:shopping-cart-off"></i>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="table-card animate-fade-in">
                <div class="table-header">
                    ...
                    <a href="{{ route('seller.products.index', ['sort' => 'bestselling']) }}" class="text-sm text-indigo-600 hover:text-indigo-800">Lihat Semua</a>
                </div>
                <div class="table-container">
                    <table class="dashboard-table">
                        <thead>
                            ...
                            <tr>
                                <td>
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex-shrink-0 rounded-md overflow-hidden bg-gray-100 mr-3">
                                            @if($product->photos->isNotEmpty())
                                                <img src="{{ Storage::url($product->photos->first()->photo) }}" alt="{{ $product->name }}" class="w-full h-full object-cover">
                                            @else
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="stars-container">
                                        @for($i = 1; $i <= 5; $i++)
                                            {{-- <i class="iconify star" data-icon="{{ $i <= $review->rating ? 'tabler:star-filled' : 'tabler:star' }}"></i> --}}
                                        @endfor
                                    </div>
                                </td>
...
<script>
    ...
    function updateSalesRevenueChart(period) {
        // In a real application, this would make an AJAX request to get data for the selected period
        // For now, we'll simulate different data for different periods
        
        // Make an AJAX request to get data for the selected period
    ...
    function updateProductPerformanceChart(metric) {
        // Get the appropriate data based on the selected metric
        const productData = {!! json_encode($productPerformanceData ?? ['labels' => [], 'sales' => [], 'revenue' => [], 'views' => []]) !!};
        ...
        window.productPerformanceChart.data.datasets[0].label = label;
        window.productPerformanceChart.data.datasets[0].data = data;
        window.productPerformanceChart.update();
    }
